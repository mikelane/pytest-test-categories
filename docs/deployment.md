...
This document describes the CI/CD infrastructure and deployment process for pytest-test-categories.
...
5. **Create GitHub Release**
   ...
   - Go to: https://github.com/mikelane/pytest-test-categories/releases/new
   - Tag: `v{version}` (matches the tag you pushed)
   - Title: `v{version}`
   - Description: Copy relevant section from CHANGELOG.md
   - Click "Publish release"

6. **Monitor CD Pipeline**

   - GitHub Actions will automatically trigger
   - Watch: https://github.com/mikelane/pytest-test-categories/actions
   - Pipeline validates version, builds, tests installation, publishes to PyPI
...
7. **Verify PyPI Publication**
   ...
   Visit: https://pypi.org/project/pytest-test-categories/

### Pre-release Testing (Optional)

Test the release process without publishing to production PyPI:

1. **Trigger Manual Workflow**

   - Go to: Actions → CD - Publish to PyPI
   - Click "Run workflow"
...
3. **Notify Users**
   ...
   - Post issue explaining the problem and fix
